                  ...
                  <ul>
                    <li>
                      <i onClick={handleLike} >
                        {likeStatus ? <FaHeart color="#00FF7F" /> :
                          <FaRegHeart />
                        }
                      </i>
                      <b className='likecount'
                        style={likeStatus ? { color: "rgb(99, 99, 99)" } : { color: "rgb(99, 99, 99)" }}
                      >  {likeCount}
                      </b>
                    </li>
                    <li>
                  ...
                  <ul>
                    <li>
                      <i onClick={addStoryToReadList}>
                        ...
                        {storyReadListStatus ? <BsBookmarkFill color='#00FF7F' /> :
                          <BsBookmarkPlus />
                        }
                      </i>
                    </li>
